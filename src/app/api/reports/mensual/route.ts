...
export async function GET() {
  try {
    ...
    doc.text(`Período: ${formatFullDate(monthStart)} - ${formatFullDate(monthEnd)}`, 105, 30, { align: "center" });
    ...
    return new NextResponse(pdfBuffer, {
      headers: {
        ...
        "Content-Disposition": `attachment; filename="reporte_mensual_${today}.pdf"`,
      },
    });
  } catch (error: any) {
